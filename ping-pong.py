...
while True:
    ...
    if (360 < hit_ball.xcor() < 370) and (right_paddle.ycor() + 40 > hit_ball.ycor() > right_paddle.ycor() - 40):
        hit_ball.setx(360)
        hit_ball.dx *= -1

    if (-360 > hit_ball.xcor() > -370) and (left_paddle.ycor() + 40 > hit_ball.ycor() > left_paddle.ycor() - 40):
        hit_ball.setx(-360)
        hit_ball.dx *= -1
